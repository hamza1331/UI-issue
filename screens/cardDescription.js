...
import {Platform, Text, View,ScrollView,Image,Alert} from 'react-native';
...
_toggleDespModal = () =>this.setState({ Despmodal: false });
UNSAFE_componentWillReceiveProps(newProps){
  this.setState({
    ...
    render(){
      return(
   <Modal isVisible={this.state.Despmodal} 
   onBackButtonPress={this._toggleDespModal}
   ...
   />
     ...
     />
       ...
       source={{
         uri:
           'https://s3.amazonaws.com/uifaces/faces/twitter/ladysexy/128.jpg',
       }}
     />  
     <View style={{marginLeft:15}}>
       <Text style={{fontSize:20,fontWeight:'bold',color:'black',marginBottom:5}}>ALI</Text>
       <Rating 
     type='star'
     ratingCount={5}
     imageSize={20}
   ...
   />
       ...
       <View style={{backgroundColor:'orange',position: 'absolute', left: 0, right: 0, bottom: 0,height:40,width:'100%',alignItems:'center',justifyContent:'center'}}>
